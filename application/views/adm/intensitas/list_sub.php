				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Detil Kriteria</h2>
						<div class="box-icon">
						...
						<table id="view" class="table table-bordered table-striped" style="tr td:first-child{width:20%;}">
						 ...
						 <table class="table table-bordered table-striped">
						 	...
						 	<?php if( count($subkriterias) <= 0 ){ ?>
						 		<tr><td colspan="3">Tidak ada subkriteria</td></tr>
						 	<?php }else{ ?>
						 		<?php foreach ($subkriterias as $key => $subkriteria) { ?>
							 		<tr>
									 	...
									 	<td class="center">
											<a class="btn btn-success" href="<?php echo site_url('administrasi/input_intensitas/'.$subkriteria['id_kriteria']) ?>">
